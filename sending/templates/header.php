...
if($_SESSION["name"] && ! in_array('register', $uriSegments) && ! in_array('login', $uriSegments)){
?>
<!--Welcome <?php //echo $_SESSION["name"]; ?>. Click here to <a href="/all-projects/simple-note/new/logout.php" tite="Logout">Logout.</a>-->
<?php
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<!--<script src="<?php echo $siteUrl; ?>assets/js/app-ajax.js" type="text/javascript"></script>-->
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <!--<li><a href="<?php //echo $siteUrl; ?>profile-dash"><span><i class="fas fa-user"></i></span> Profile</a></li>
            <li role="separator" class="divider"></li>-->
            <li><a href="<?php echo $siteUrl; ?>profile-dash"><span><i class="fas fa-cogs"></i></span> Setting</a></li>
            <li role="separator" class="divider"></li>
			<li><a href="<?php echo $siteUrl; ?>our-plans"><span><i class="fas fa-user"></i></span> Membership</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="<?php echo $siteUrl; ?>logout"><span><i class="fas fa-sign-out-alt"></i></span> Logout</a></li>
          </ul>
        </li>
      </ul>
    </div><!-- /.navbar-collapse -->
