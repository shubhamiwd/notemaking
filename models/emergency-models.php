    ...
    <div class="modal-content">
         ...
         <div class="col-md-12">
	        <div class="row">
				...
				<ul class="modal-ch urq" style="text-align: center;">
					...
					<li class="">
			          	<input type='checkbox' id="co_3" class="co_select" data-sectionId="teeth_sel" name="co_select" value='Bleeding Gums'>
						<label for="co_3">Bleeding Gums</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="co_4" class="co_select" data-sectionId="teeth_sel" name="co_select" value='Fractured Tooth'>
						<label for="co_4">Fractured Tooth</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="co_5" class="co_select" data-sectionId="teeth_sel" name="co_select" value='Loss of Tooth'>
						<label for="co_5">Loss of Tooth</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="co_6" class="co_select" data-sectionId="teeth_sel" name="co_select" value='Cavities'>
						<label for="co_6">Cavities</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="co_7" class="co_select" data-sectionId="teeth_sel" name="co_select" value='Appearance'>
						<label for="co_7">Appearance</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="co_8" class="co_select" data-sectionId="teeth_sel" name="co_select" value='Sensitivity'>
						<label for="co_8">Sensitivity</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="co_9" class="co_select" data-sectionId="teeth_sel" name="co_select" value='Other'>
						<label for="co_9">Other</label>
					</li>
				</ul>
         	</div>	
          </div>
      ...
      <div class="modal-footer">
       <button type="button" class="btn cp_cl closebtn each_model_data" data-teethname="Presenting Complaint" id="add_val_demo" data-spancls="co_sel_teeth" data-checkedvalid="co_sel" data-clicked_1="co_option_sel" data-fieldname="co_select" data-dismiss="modal" aria-label="Close">Add Note</button>
	   <!--<button type="button" class="closebtn" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
...
<div class="modal fade" id="myModal_4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg small_popup" role="document">
    <div class="modal-content">
      <div class="modal-header allmodalheading">
		<h5>Vitality Test : Select Option</h5>
       <!-- <button type="button" class="closebtn" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
      </div>
      <div class="modal-body">
        <div class="row">
         ...
         <div class="col-md-12">
	        <div class="row">
				...
				<ul class="modal-ch urq" style="text-align: center;">
					<li class="">
			          	<input type='checkbox' id="st_1" class="co_select" data-sectionId="teeth_sel" name="s_test" value='Nil'>
						<label for="st_1">Nil</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="st_2" class="co_select" data-sectionId="teeth_sel" name="s_test" value='EPT'>
						<label for="st_2">EPT</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="st_3" class="co_select" data-sectionId="teeth_sel" name="s_test" value='Endoforst'>
						<label for="st_3">Endoforst</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="st_4" class="co_select" data-sectionId="teeth_sel" name="s_test" value='TTP'>
						<label for="st_4">TTP</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="st_5" class="co_select" data-sectionId="teeth_sel" name="s_test" value='Mobility'>
						<label for="st_5">Mobility</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="st_6" class="co_select" data-sectionId="teeth_sel" name="s_test" value='Other'>
						<label for="st_6">Other</label>
					</li>
				</ul>
         	</div>	
          </div>
      ...
      <div class="modal-footer">
       <button type="button" class="btn cp_cl closebtn each_model_data" data-teethname="Special Tests" id="add_val_demo" data-spancls="spl_tst" data-checkedvalid="spl_test" data-clicked_1="co_option_sel" data-fieldname="s_test" data-dismiss="modal" aria-label="Close">Add Note</button>
	   <!--<button type="button" class="closebtn" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
		<!--<div id="add_val" class="btn cp_cl close">Add</div>-->
      </div>
    </div>
...
<div class="modal fade" id="myModal_5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg small_popup" role="document">
    <div class="modal-content">
        ...
        <div class="row">
         ...
         <div class="col-md-12">
	        <div class="row">
				...
				<ul class="modal-ch urq" style="text-align: center;">
					<li class="">
			          	<input type='checkbox' id="md5_1" class="co_select" data-sectionId="teeth_sel" name="diag_no" value='Nil'>
						<label for="md5_1">Nil</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="md5_2" class="co_select" data-sectionId="teeth_sel" name="diag_no" value='Broken Tooth'>
						<label for="md5_2">Broken Tooth</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="md5_3" class="co_select" data-sectionId="teeth_sel" name="diag_no" value='Enamel Caries'>
						<label for="md5_3">Enamel Caries</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="md5_4" class="co_select" data-sectionId="teeth_sel" name="diag_no" value='Dentine Caries'>
						<label for="md5_4">Dentine Caries</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="md5_5" class="co_select" data-sectionId="teeth_sel" name="diag_no" value='Deep dentine caries'>
						<label for="md5_5">Deep dentine caries</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="md5_6" class="co_select" data-sectionId="teeth_sel" name="diag_no" value='Reversible pulpitis'>
						<label for="md5_6">Reversible pulpitis</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="md5_7" class="co_select" data-sectionId="teeth_sel" name="diag_no" value='Irreversible pulpitis'>
						<label for="md5_7">Irreversible pulpitis</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="md5_8" class="co_select" data-sectionId="teeth_sel" name="diag_no" value='AAP'>
						<label for="md5_8">AAP</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="md5_9" class="co_select" data-sectionId="teeth_sel" name="diag_no" value='CAP'>
						<label for="md5_9">CAP</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="md5_10" class="co_select" data-sectionId="teeth_sel" name="diag_no" value='Pericoronitis'>
						<label for="md5_10">Pericoronitis</label>
					</li>
					<li class="">
			          	<input type='checkbox' id="md5_11" class="co_select" data-sectionId="teeth_sel" name="diag_no" value='Alveolar Osteitis'>
						<label for="md5_11">Alveolar Osteitis</label>
					</li>
				</ul>
         	</div>	
          </div>
      ...
      <div class="modal-footer">
       <button type="button" class="btn cp_cl closebtn each_model_data" data-teethname="Diagnosis" id="add_val_demo" data-spancls="dia" data-checkedvalid="dia_sis" data-clicked_1="co_option_sel" data-fieldname="diag_no" data-dismiss="modal" aria-label="Close">Add Note</button>
	   <!--<button type="button" class="closebtn" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
		<!--<div id="add_val" class="btn cp_cl close">Add</div>-->
      </div>
    </div>
