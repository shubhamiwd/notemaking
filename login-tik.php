<?php 
include 'ticket/init.php';
if($users->isLoggedIn()){
	header('Location: ./');
}
$errorMessage = $users->login();
include('ticket/inc/header.php');

?>
<title>Note Making APP Support.</title>
<?php include('ticket/inc/container.php');?>
...
<?php include('ticket/inc/footer.php');?>